...
# 16gb ram & gtx 980 / 32 gb ram & xeon cpu

# Decided to write this quick tutorial cause it's my first time 
# doing image classification and I had lot of troubles seting everything up in R on windows platform.
# So maybe it will help someone to avoid this initial pitfals/problems

# If you experience CUDA OUT_OF_MEMORY or you see lot of RAM used by the cpu version running this example network 
# then go to line 201 in the model.R
# of the R-package and add gc() command
# or use it in the mlogloss function
# the mxnet can't free ram before r garbage collector runs
